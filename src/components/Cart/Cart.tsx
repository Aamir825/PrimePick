    ...
    <div className="py-10">
      ...
      {cartItems.length === 0 ? (
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          {/* Summary Section */}
          <div className="flex flex-col bg-white border rounded-lg shadow-md p-6">
            <div className="">
            ...
            <div className="mt-auto">
              <button className="w-full cursor-pointer bg-gradient-to-br from-[#041107] via-[#0e5718] to-[#031406] text-white py-3 rounded-lg font-semibold hover:bg-indigo-700 transition">
                Proceed to Checkout
              </button>
            </div>
          </div>
